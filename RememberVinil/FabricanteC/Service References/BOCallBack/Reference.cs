...
namespace FabricanteC.BOCallBack {
    ...
    public interface IBackOfficeCallBackService {
        ...
        string GetStatus(FabricanteC.BOCallBack.ObjectMakeCDResponse response);
        ...
        string UpdateOrderTransportStatus(FabricanteC.BOCallBack.TransportJobResponse response);
        ...
        string GetTransporterPrice(FabricanteC.BOCallBack.TransportJobPriceResponse response);
        ...
        string GetFabricantePrice(FabricanteC.BOCallBack.FabricantePriceResponse response);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBackOfficeCallBackServiceChannel : FabricanteC.BOCallBack.IBackOfficeCallBackService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BackOfficeCallBackServiceClient : System.ServiceModel.ClientBase<FabricanteC.BOCallBack.IBackOfficeCallBackService>, FabricanteC.BOCallBack.IBackOfficeCallBackService {
        ...
        public string GetStatus(FabricanteC.BOCallBack.ObjectMakeCDResponse response) {
            return base.Channel.GetStatus(response);
        }
        
        public string UpdateOrderTransportStatus(FabricanteC.BOCallBack.TransportJobResponse response) {
            return base.Channel.UpdateOrderTransportStatus(response);
        }
        
        public string GetTransporterPrice(FabricanteC.BOCallBack.TransportJobPriceResponse response) {
            return base.Channel.GetTransporterPrice(response);
        }
        
        public string GetFabricantePrice(FabricanteC.BOCallBack.FabricantePriceResponse response) {
