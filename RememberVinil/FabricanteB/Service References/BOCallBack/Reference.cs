...
namespace FabricanteB.BOCallBack {
    ...
    public interface IBackOfficeCallBackService {
        ...
        string UpdateOrderTransportStatus(FabricanteB.BOCallBack.TransportJobResponse response);
        ...
        string GetFabricantePrice(FabricanteB.BOCallBack.FabricantePriceResponse response);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBackOfficeCallBackServiceChannel : FabricanteB.BOCallBack.IBackOfficeCallBackService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BackOfficeCallBackServiceClient : System.ServiceModel.ClientBase<FabricanteB.BOCallBack.IBackOfficeCallBackService>, FabricanteB.BOCallBack.IBackOfficeCallBackService {
        ...
        public string UpdateOrderTransportStatus(FabricanteB.BOCallBack.TransportJobResponse response) {
            return base.Channel.UpdateOrderTransportStatus(response);
        }
        
        public string GetTransporterPrice(FabricanteB.BOCallBack.TransportJobPriceResponse response) {
            return base.Channel.GetTransporterPrice(response);
        }
        
        public string GetFabricantePrice(FabricanteB.BOCallBack.FabricantePriceResponse response) {
